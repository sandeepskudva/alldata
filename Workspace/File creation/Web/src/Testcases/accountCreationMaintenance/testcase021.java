...
public class testcase021 extends driverScript  {

	public void case021(ExtentReports report,ExtentTest logger,int Rownum) throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException 
	{
		...
		if(status)status=pm.validatePaymentPage(report, logger,Rownum);
