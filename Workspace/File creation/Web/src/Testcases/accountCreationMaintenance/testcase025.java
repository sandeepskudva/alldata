...
public class testcase025 extends driverScript  {

	public void case025(ExtentReports report,ExtentTest logger,int Rownum) throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException 
	{
		...
		if(status)status=tp.searchByTranDateOptionalN(report, logger, Rownum, "tx_date");
