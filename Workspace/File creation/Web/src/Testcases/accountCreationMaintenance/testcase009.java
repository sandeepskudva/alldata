...
public class testcase009 extends driverScript  {

	public void case009(ExtentReports report,ExtentTest logger,int Rownum) throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, SQLException 
	{
		...
		if(status)status=ep.addressSection(report, logger, Rownum);		
