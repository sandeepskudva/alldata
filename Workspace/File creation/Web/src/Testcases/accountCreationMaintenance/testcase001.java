...
public class testcase001 extends driverScript {

	public void case001(ExtentReports report,ExtentTest logger,int Rownum) throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException 
	{
    	...
    	if(status)status=a.fillNameAdressSection(report,logger,Rownum,"PRIVATE","No");
