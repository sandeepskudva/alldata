...
public class testcase011 extends driverScript  {

	public void case011(ExtentReports report,ExtentTest logger,int Rownum) throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, SQLException 
	{
		...
		if(status)status=ep.statementSection(report, logger, Rownum);
