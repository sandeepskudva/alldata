...
public class FileCreationTRBig {
	...
	public static void main (String args[]) throws EncryptedDocumentException, InvalidFormatException, IOException, SQLException, ClassNotFoundException
	{
		functions a = new functions();
		int agency = 1;
	//			Integer.parseInt(JOptionPane.showInputDialog("Please select Agency : \n 1. NJTP \n 2. GSP \n 3. DRBA \n 4. DRPA \n 5. SJTA \n 6. DRJ \n 7. BCBC \n 8. Exit"));
...
public static String getxferid(String filename) throws SQLException, ClassNotFoundException
{
		...
		String dbURL1 = "jdbc:oracle:thin:@(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST = 10.36.20.51)(PORT = 1521))(CONNECT_DATA = (SERVER = DEDICATED)(SERVICE_NAME = njrbtst)))";
...
public void createFile(int agency) throws EncryptedDocumentException, InvalidFormatException, IOException, SQLException, ClassNotFoundException
{
	String agencyname;
