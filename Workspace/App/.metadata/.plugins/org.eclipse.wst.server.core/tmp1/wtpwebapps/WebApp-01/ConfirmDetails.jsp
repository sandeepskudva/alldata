...
<script type="text/javascript" src="D://TSG/Workspace/App/WebApp-01/WebContent/WEB-INF/libjquery-3.1.1.min.js"></script>
...
{	
document.location.href("CreateNew.jsp"); 
}
...
<%   String DB = request.getParameter("DB");
     ...
     String ViolType =  request.getParameter("ViolType");
  ...
  <table>
   ...
   <tr><whi/>Transaction Date :<%=Trxdate%> </tr>
   <tr><whi/>Number of Notices :<%=NumOfN%> </tr>
   <tr><whi/>Violation Type :<%=ViolType%> </tr>
  
   <tr><whi/>Total number of Violations in File :<%=count%> </tr>
   
   <%String macroname =agencyname+"ViolMacro"; %>   
    <%common.ExcelWrite("PlateDetails", "D:\\TSG\\Workspace\\App\\WebApp-01\\"+macroname+".xlsm", 1, 6,NumOfN);
   common.ExcelWrite("PlateDetails", "D:\\TSG\\Workspace\\App\\WebApp-01\\"+macroname+".xlsm", 1, 7,count+"");
   common.ExcelWrite("PlateDetails", "D:\\TSG\\Workspace\\App\\WebApp-01\\"+macroname+".xlsm", 1, 8,ViolType);%>
   <%=uploadFile.EnterDBselection(DB)%>
   <%=uploadFile.feedFile(filedate, filetime, Trxdate, count,agencyname)%> 
   <%=uploadFile.Enteragencyselection(agencyname)%>
 
  
  <tr><a href="CreateNew.jsp"><input type="button" value="Back" name="cancel"></a></tr>
  <tr><a href="XferFileCreation.jsp"><input type="button" value="Create File" name="Create File"></a></tr>    </tr>
