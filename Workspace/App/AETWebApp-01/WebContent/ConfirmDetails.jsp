...
<%   String agencyname = request.getParameter("agencyid");
  ...
  <table>
   ...
   <%String macroname =agencyname+"ViolMacro"; %>   
    <%common.ExcelWrite("PlateDetails", "E:\\TSG\\Workspace\\App\\WebApp-01\\"+macroname+".xlsm", 1, 6,NumOfN);
   common.ExcelWrite("PlateDetails", "E:\\TSG\\Workspace\\App\\WebApp-01\\"+macroname+".xlsm", 1, 7,count+"");
   common.ExcelWrite("PlateDetails", "E:\\TSG\\Workspace\\App\\WebApp-01\\"+macroname+".xlsm", 1, 8,ViolType);%>
