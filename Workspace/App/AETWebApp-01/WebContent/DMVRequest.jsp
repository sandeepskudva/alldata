...
<div class="loader"></div>
<div class="stitched">
<h1>DMV Request Page</h1>
</div>
<center><img src='IMG/status6.png' ></img></center>
<nav>
  <ul class="top-menu">
...
<p style = "font-weight: bold;">Send Violations to DMV </p>

 
</table>

 
<tr><button type="submit" name="RunDMVRequest" value="RunDMVRequest">Run DMV Request Job</button></tr>
  </table> <br>  
</form>
</body>
</html>
