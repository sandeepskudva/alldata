...
public static void insertxferid(String filename,int agency) throws SQLException, EncryptedDocumentException, InvalidFormatException, org.apache.poi.openxml4j.exceptions.InvalidFormatException, IOException
{
	String DBSel = uploadFile.getDBselection();
    String dbURL = null;
    String strUserID = null;
...
public void createFile(int agency) throws EncryptedDocumentException, InvalidFormatException, IOException, SQLException, InterruptedException, org.apache.poi.openxml4j.exceptions.InvalidFormatException
{
	...
	String Path1 = "D:\\TSG\\Workspace\\File creation\\Macro code\\"+agencyname+"\\Smart File Creator.xlsm";  
    ...
    ExcelWrite("Data3", Path1, 6, 1,XFERID); 
     ...
     String Outputpath = "D:\\TSG\\Workspace\\File creation\\Macro code\\"+agencyname;
     String filepath = "D:\\TSG\\Workspace\\File creation\\Macro code\\Output";
